 ...
 */
export function formatDateThaiLong(value: string | Date | null | undefined): string {
  if (value == null || value === "") return "";
  const d = typeof value === "string" ? new Date(value) : value;
 ...
 */
export function formatDateTimeThaiForReport(value: string | Date | null | undefined): string {
  if (value == null || value === "") return "";
  const d = typeof value === "string" ? new Date(value) : value;
